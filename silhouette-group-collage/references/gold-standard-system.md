...
These five recipes are distilled from the user's approved first-generation artworks. The original artworks remain private. Public skill assets contain only non-person paper texture samples and transferable design data.

Use the recipes as a quality floor. Select by scene geometry and emotional structure; do not reproduce one composition mechanically.

## G1: saffron winter horizon

- Best for: small horizontal groups in expansive landscape.
...
## G2: icy-blue cabin warmth

- Best for: intimate indoor groups gathered around a table or window.
...
## G3: plum winter company

- Best for: close group plus companion animal or object.
...
## G4: teal movement chain

- Best for: side-view walking, dancing, or people connected through gestures.
...
## G5: crimson dual-depth team

- Best for: one large foreground photographer or observer plus a smaller background group.
...
- Tight silhouettes without thick outlines or broad halos.
- Source people remain original pixels in every visible-photo state.
- Environment and paper quiet space carry more area than decoration.
- One decisive scene-derived paper colour.
- One large scene-matched handwritten phrase with controlled word-level variation.
- Scanned paper fibres remain visible at normal size.
- Stars vary in size, fill, rotation, colour, and spacing.
